...
def editprofile(request):
    ...
    if request.method=='POST':
        ...
        profile.team_mate_name = request.POST['team_mate']
        profile.team_mate_email = request.POST['team_mate_email']
        profile.team_mate_contact = request.POST['team_mate_contact']
        profile.save()
